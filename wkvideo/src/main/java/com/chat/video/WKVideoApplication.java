...
public class WKVideoApplication {
    ...
    public void init(Context context) {
        ...
        // 注册长按菜单
        EndpointManager.getInstance().setMethod(EndpointCategory.msgConfig + WKContentType.WK_VIDEO, object -> new MsgConfig());
            ...
            WKPermissions.getInstance().checkPermissions(new WKPermissions.IPermissionResult() {
                ...
                public void onResult(boolean result) {
                    if (result) {
                        ...
                        WKPermissions.getInstance().checkPermissions(new WKPermissions.IPermissionResult() {
                            @Override
                            public void onResult(boolean micResult) {
                                if (micResult) {
                        ...
                        }, iConversationContext.getChatActivity(), desc, Manifest.permission.RECORD_AUDIO);
                    }
                }
